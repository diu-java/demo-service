...
@SecurityScheme(name = "OpenIdConnect", type = SecuritySchemeType.OPENIDCONNECT, openIdConnectUrl = "https://auth0.diu.edu.bd/realms/diu/.well-known/openid-configuration", description = "openid connect" )
